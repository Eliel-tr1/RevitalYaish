...
while True:
    req = urllib.request.Request(URL,
        data=json.dumps({"objectType": 1039,
            "fields": [{"name":"pcfExternalSoftwareID1"},{"name":"pcfPaymentType"},{"name":"pcfNeedToPayIncludingVat"},{"name":"pcfAccountid"},{"name":"createdon"},{"name":"pcfNumberOfPayments"}],
    ...
    page += 1
    time.sleep(1.0)
with open(r"C:\Users\sahar\Claude Code\RevitalYaish\_reconciliation\pays_full_with_acct.json", "w", encoding="utf-8") as f:
